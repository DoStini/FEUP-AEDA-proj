...
public:
    ...
    */
     ...
     */
    void startPublicStream(std::string title, languages language, genres genre, unsigned minAge);
    /**
     ...
     * @param minAge - Minimal age of the stream , 12 by default
     */
    void startPrivateStream(std::string title, languages language, genres genre, unsigned minAge);
